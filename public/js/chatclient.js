  ...
  for (var i = 0; i < usr.length; i++) {
    if (usr[i] != nickname.value) {
      var div = document.createElement("div"),
        ...
        div2.innerHTML = "<img src='https://vitormadeira.files.wordpress.com/2011/09/portimao_de_noite-ricardo_santos_scotxx.jpg' class='img-stylish ptrl-right img-rounded text-right img-thumbnail'>"
...
socket.on('message', function(data, user) {
  var div = ` <section class="col-xs-9">
              ...
              <span><em>
                <img class="img" src="https://vitormadeira.files.wordpress.com/2011/09/portimao_de_noite-ricardo_santos_scotxx.jpg">
              </span>
                    <p class="text-right">
                    <span>
                    ${data.msg}
    ...
    div2 = ` <section class="col-xs-9">
              ...
              <span><em>
                <img class="img2" src="https://vitormadeira.files.wordpress.com/2011/09/portimao_de_noite-ricardo_santos_scotxx.jpg">
              </span>
                    <p>
                    <span>
                    ${data.msg}
